...
menusmap: {},
preloadimages: [],
effects: {delayhide: 90, shadow:{enabled:true, opacity:0.3, depth: [5, 5]}, fade:{enabled:true, duration:500}}, //customize menu effects
...
setupmenu:function(targetclass, anchorobj, pos){
	...
	this.addEvent([menu.anchorobj, menu.dropmenu, menu.shadow], function(e){ //MOUSEOVER event for anchor, dropmenu, shadow
		...
		if (this._isanchor && menu.revealtype=="mouseover" && !anylinkmenu.isContained(this, e)){ //event for anchor
			window.setInterval(anylinkmenu.showmenu(menu.id),5000);
			window.setInterval(anylinkmenu.addState(this, "add"),5000);
		}
